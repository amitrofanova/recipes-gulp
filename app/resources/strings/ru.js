...
// export const LOGIN_HEADER_TEXT = 'Добро пожаловать в Книгу Рецептов';
// export const LOGIN_SUB_HEADER_TEXT = 'Ваша личная коллекция рецептов';
// export const USERNAME_PLACEHOLDER = 'Имя пользователя';
// export const PASSWORD_PLACEHOLDER = 'Пароль';
// export const LOGIN_BUTTON_TEXT = 'Войти';
// export const REGISTER_HEADER_TEXT = 'Впервые на сайте?';
// export const REGISTER_SUB_HEADER_TEXT = 'Зарегистрируйтесь с электронной почтой';
